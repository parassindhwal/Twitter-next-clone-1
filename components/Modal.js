...
function Modal() {
  ...
  return (
    <Transition.Root show={isOpen} as={Fragment}>
      <Dialog as="div" className="fixed z-50 inset-0 pt-8 overflow-y-auto scrollbar-hide" onClose={setIsOpen}>
                        ...
                        <div className="mt-7 flex space-x-3 w-full">
                            ...
                            <div className="flex-grow mt-2">
                                <textarea
                                    ...
                                    rows="2"
                                    className="bg-transparent outline-none text-[#d9d9d9] text-lg placeholder-gray-500 tracking-wide w-full min-h-[80px] scrollbar-thin scrollbar-thumb-gray-700 overflow-y-auto"
                                />
